...
//the readCSV method splits a value into a slice based on the commma separator
...
//If the value cannot be converted to an integer then the validation is added to
